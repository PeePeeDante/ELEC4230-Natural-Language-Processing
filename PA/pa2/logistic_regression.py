...
from preprocess import data_preprocess, embedding_score
...
if __name__ == "__main__":
    ...
    print('[loading word2vec.csv...]')
    with open("word2vec.csv") as csv_file:
        reader = csv.reader(csv_file)
        word2vec = dict(reader)
    ...
    data1, label = embedding_score(revs, word2vec, wrd_emb)
    data = data1
    ...
    test_data, _ = embedding_score(revs, word2vec, wrd_emb)
